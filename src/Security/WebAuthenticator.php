...
class WebAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    final public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (null === $user) {
            ...
            throw new CustomUserMessageAuthenticationException('Identifiants introuvables.');
        }
    ...
    final public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $providerKey): Response
    {
